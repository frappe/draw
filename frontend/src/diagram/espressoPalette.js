...
export const ESPRESSO_FAMILIES = [
  { name: 'gray', shades: ['#F3F3F3', '#E2E2E2', '#999999', '#7C7C7C', '#525252', '#171717'] },
...
// Neutral endpoints offered alongside the grid (a fill can be plain white, a
// border/ink plain black). White also renders a "no fill" node cleanly.
export const NEUTRALS = { white: '#FFFFFF', black: '#000000' }
